...
def read_bagfile(bag_file, topic):
    topic_bag = bag_file.message_by_topic(topic)
    # convert to dataframe
    topic_df = pd.read_csv(topic_bag)
    print(len(topic_df))
    print(topic_df.columns.to_list())
    print(topic_df.head())
    return topic_df
